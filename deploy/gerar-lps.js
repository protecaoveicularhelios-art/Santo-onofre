...
function gerarPagina(nome, slug) {
  return `<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8"/>
...
cidades.forEach(([nome, slug]) => {
  const html = gerarPagina(nome, slug);
  const filename = `seguranca-${slug}.html`;
  fs.writeFileSync(filename, html, 'utf8');
  console.log(`✓ ${filename}`);
});

console.log(`\n✅ ${cidades.length} páginas geradas com sucesso!`);
