...
<link rel="canonical" href="https://santoonofreservicos.com.br/seguranca-{slug}.html"/>
<script type="application/ld+json">
{{"@context":"https://schema.org","@type":"LocalBusiness","name":"Santo Onofre Serviços","description":"Empresa de segurança patrimonial em {nome}, MG","url":"https://santoonofreservicos.com.br","telephone":"+5531987299396","areaServed":"{nome}, Minas Gerais","serviceType":"Segurança Patrimonial","address":{{"@type":"PostalAddress","addressLocality":"{nome}","addressRegion":"MG","addressCountry":"BR"}}}}
</script>
<style>
...
.sec{{padding:72px 6%;}}
.sec-light{{background:var(--li);}}.sec-dark{{background:#000;}}
...
.srv-card{{background:#fff;border-radius:14px;padding:26px 22px;border:1px solid var(--bo);transition:.3s;position:relative;overflow:hidden;}}
...
.cidade-tag{{background:#fff;border:1px solid var(--bo);border-radius:8px;padding:10px 14px;font-size:12px;color:var(--mu);font-weight:500;text-align:center;transition:.2s;}}.cidade-tag:hover{{border-color:var(--gold);color:#0B1829;background:var(--gd);}}
...
<div id="topbar"><div class="tb-wrap">
  <a href="tel:+5531987299396" class="tb-item"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.7)" stroke-width="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8 19.79 19.79 0 01.22 2.18 2 2 0 012.18 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.72 6.72l1.28-1.28a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>Contrate: (31) 98729-9396</a>
  <a href="https://instagram.com/santoonofrevigilangia" target="_blank" class="tb-item"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.7)" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>@santoonofrevigilangia</a>
</div></div>

<nav id="nav">
  <a href="index.html" class="nlogo"><img src="navbaronofre.jpg" alt="Santo Onofre Segurança" style="height:52px;width:auto;object-fit:contain;"></a>
  <div class="nlinks">
...
<div class="mob" id="mob">
  <a href="index.html" onclick="cm()">Home</a>
...
<section class="lp-hero">
  <div class="lp-hero-wrap">
    <div class="breadcrumb"><a href="index.html">Início</a><span>›</span><span style="color:rgba(255,255,255,.5)">Segurança em {nome}</span></div>
...
<section class="sec sec-light">
  <div class="wrap">
    ...
    <h2>Segurança Completa para<br>Empresas em {nome}, MG</h2>
    ...
    <div class="srv-grid">
      <div class="srv-card"><div class="srv-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" stroke-width="1.8"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div><h3>Vigilância Patrimonial</h3><p>Vigilantes certificados para proteção ostensiva de empresas, condomínios e indústrias em {nome} 24 horas.</p></div>
      <div class="srv-card"><div class="srv-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" stroke-width="1.8"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg></div><h3>Controle de Acesso</h3><p>Gestão eletrônica e presencial de entrada e saída com registros completos para empresas em {nome}.</p></div>
      <div class="srv-card"><div class="srv-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" stroke-width="1.8"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div><h3>Monitoramento Eletrônico</h3><p>Câmeras CFTV e central de monitoramento 24h integrados à vigilância presencial em {nome}.</p></div>
      <div class="srv-card"><div class="srv-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg></div><h3>Rondas Ostensivas</h3><p>Patrulhamento preventivo em horários programados e aleatórios para máxima proteção do seu patrimônio.</p></div>
      <div class="srv-card"><div class="srv-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" stroke-width="1.8"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg></div><h3>Segurança em Eventos</h3><p>Equipes especializadas para eventos corporativos, formaturas e shows em {nome} e região.</p></div>
      <div class="srv-card"><div class="srv-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" stroke-width="1.8"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><path d="M9 22V12h6v10"/></svg></div><h3>Portaria Profissional</h3><p>Porteiros treinados para triagem, identificação e atendimento em condomínios e empresas de {nome}.</p></div>
    </div>
  </div>
</section>
...
<section class="sec sec-dark">
  <div class="wrap">
    ...
    <h2>Referência em Segurança<br>em {nome} e MG</h2>
...
<section class="sec sec-light">
  <div class="wrap">
    ...
    <h2>Atendemos {nome} e Toda a Região</h2>
    ...
    <div class="cidades-grid">
      <a href="seguranca-belo-horizonte.html" class="cidade-tag">Belo Horizonte</a>
      <a href="seguranca-uberlandia.html" class="cidade-tag">Uberlândia</a>
      <a href="seguranca-contagem.html" class="cidade-tag">Contagem</a>
      <a href="seguranca-juiz-de-fora.html" class="cidade-tag">Juiz de Fora</a>
      <a href="seguranca-betim.html" class="cidade-tag">Betim</a>
      <a href="seguranca-montes-claros.html" class="cidade-tag">Montes Claros</a>
      <a href="seguranca-uberaba.html" class="cidade-tag">Uberaba</a>
      <a href="seguranca-governador-valadares.html" class="cidade-tag">Gov. Valadares</a>
      <a href="seguranca-ipatinga.html" class="cidade-tag">Ipatinga</a>
      <a href="seguranca-sete-lagoas.html" class="cidade-tag">Sete Lagoas</a>
      <a href="seguranca-divinopolis.html" class="cidade-tag">Divinópolis</a>
      <a href="seguranca-pocos-de-caldas.html" class="cidade-tag">Poços de Caldas</a>
      <a href="seguranca-varginha.html" class="cidade-tag">Varginha</a>
      <a href="seguranca-itabira.html" class="cidade-tag">Itabira</a>
      <a href="seguranca-pouso-alegre.html" class="cidade-tag">Pouso Alegre</a>
    </div>
  </div>
</section>
...
<footer>
  <div class="wrap">
    <div class="footer-grid">
      <div><span class="ft-name">Santo Onofre Serviços</span><p class="ft-desc" style="margin-top:8px;">Segurança patrimonial em {nome} e em toda Minas Gerais. Mais de 10 anos de experiência.</p></div>
      ...
      <div><div class="ft-title">Cidades</div><a href="seguranca-belo-horizonte.html" class="ft-link">Belo Horizonte</a><a href="seguranca-contagem.html" class="ft-link">Contagem</a><a href="seguranca-betim.html" class="ft-link">Betim</a><a href="seguranca-uberlandia.html" class="ft-link">Uberlândia</a></div>
      <div><div class="ft-title">Fale Conosco</div><a href="https://wa.me/5531987299396" class="ft-link" target="_blank">(31) 98729-9396</a><a href="mailto:contato@santoonofreservicos.com.br" class="ft-link">contato@santoonofreservicos.com.br</a><span class="ft-link" style="cursor:default">Minas Gerais</span></div>
    </div>
    <div class="ft-bottom"><span class="ft-copy">© 2026 Santo Onofre Serviços · Todos os direitos reservados</span></div>
  </div>
</footer>

<a href="https://wa.me/5531987299396" class="wa" target="_blank" rel="noopener"><svg width="26" height="26" viewBox="0 0 24 24" fill="#fff"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg></a>

<script>
document.getElementById('ham').addEventListener('click',()=>document.getElementById('mob').classList.toggle('op'));
function cm(){{document.getElementById('mob').classList.remove('op');}}
</script>
</body>
</html>"""

for nome, slug in cidades:
    html = gerar_pagina(nome, slug)
    filename = f"seguranca-{slug}.html"
    with open(filename, "w", encoding="utf-8") as f:
        f.write(html)
    print(f"✓ {filename}")

print(f"\n✅ {len(cidades)} páginas geradas com sucesso!")
